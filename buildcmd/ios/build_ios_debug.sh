...
$UNITY_PATH -projectPath $PROJ_PATH -disable-assembly-updater -executeMethod PlayerGenerator.BuildPlayerIOSDebug -quit -batchmode -logFile ${XCODE_PROJECT_PATH}/BuildLog/build_ios.log || exit
