...
$UNITY_PATH -projectPath $PROJ_PATH -disable-assembly-updater -executeMethod PlayerGenerator.BuildPlayerIOSNoResRelease -quit -batchmode -logFile ${XCODE_PROJECT_PATH}/BuildLog/build_ios.log || exit
...
ipa_name="ws_chujian_""$(date +%Y.%m.%d_%H%M)"".ipa"
