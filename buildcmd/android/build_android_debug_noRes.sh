...
$UNITY_PATH -projectPath $PROJ_PATH -executeMethod PlayerGenerator.ExportGoogleProjectNoResDebug -quit -batchmode -logFile ${PROJ_PATH}/BuildLog/build_android.log || exit
