...
$UNITY_PATH -projectPath $PROJ_PATH -executeMethod PlayerGenerator.ExportGoogleProjectRelease -quit -batchmode -logFile ${PROJ_PATH}/BuildLog/build_android.log || exit
