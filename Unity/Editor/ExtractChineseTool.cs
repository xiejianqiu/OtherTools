...
public class ExtractChineseTool : EditorWindow
{
    ...
    /// 定义要提取中文的路径
    /// </summary>
    private string[] PrefabPathArray = new string[] { @"Assets/BundleData/UI", @"Assets/BundleData/Prefab", @"Assets/ResMS/Prefab" };
    ...
    private void OnGUI()
    {
        ...
        if (bExtractChinese)
        {
            ...
            {
                var guids = AssetDatabase.FindAssets("t:prefab", PrefabPathArray);
                int nCount = 0;
