...
namespace Jenkins
{
    public partial class JenkinsBuild
    {
        ...
        public static void CheckUseHotfix()
        {
            ...
            if (EnvUtils.IsUNITY_ANDROID())
            {
                if (Enum.TryParse<BuildPkgType>(mPargmaTypeCheck.GetValue(PargmaType.BuildPkgType), out var result) && result == BuildPkgType.APK)
                {
                    ReplaceFile("PlatformRes/android/icon_one.png", "Assets/ResMS/Icon/oversea.png");
                }
                else
                { 
                    ReplaceFile("PlatformRes/android/oversea.png", "Assets/ResMS/Icon/oversea.png");
                }
            ...
            if (EnvUtils.IsUNITY_IOS())
            {
                ReplaceFile("PlatformRes/ios/oversea.png", "Assets/ResMS/Icon/oversea.png");
