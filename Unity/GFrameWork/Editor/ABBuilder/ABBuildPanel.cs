...
public class ABBuildPanel : EditorWindow
{
    ...
    [MenuItem("jenkins/build/Builde Table")]
    public static void BuildTable()
    {
        BuildAssetBundles(EditorUserBuildSettings.activeBuildTarget, false, false, false, BuildMode.BuildTb);
    }
    [MenuItem("jenkins/build/Builde HotfixCode")]
    public static void BuildHotfixCode()
    {
        BuildAssetBundles(EditorUserBuildSettings.activeBuildTarget, false, false, false, BuildMode.BuidHotfix);
    }
    [MenuItem("jenkins/build/Builde BuildTbAndfixCode")]
    public static void BuildTbAndfixCode()
    {
        BuildAssetBundles(EditorUserBuildSettings.activeBuildTarget, false, false, false, BuildMode.BuildTbAndHotfix);
    }
    public static void BuildAssetBundles(BuildTarget target, bool bIncludeScene = true,bool isBwbx = false, bool removeManifest = true, BuildMode buildMode = BuildMode.BuildAll)
    {
        ...
        builder.Begin();
        if (BuildMode.BuildAll == buildMode)
        {
...
#endif
            if (GfxLogicBrige.IsUse2UI)
            {
                builder.AddRootTargets(new DirectoryInfo("Assets/BundleData/English/NewTPProject/"), AssetBundleBuildConfig.BundleStrategy.Normal, "*.prefab");
                builder.AddRootTargets(new DirectoryInfo("Assets/BundleData/English/TPProject/"), AssetBundleBuildConfig.BundleStrategy.Normal, "*.prefab");
                builder.AddRootTargets(new DirectoryInfo("Assets/BundleData/English/NewUI/"), AssetBundleBuildConfig.BundleStrategy.Normal, "*.prefab");
                builder.AddRootTargets(new DirectoryInfo("Assets/BundleData/English/UI/"), AssetBundleBuildConfig.BundleStrategy.Normal, "*.prefab");
                builder.AddRootTargets(new DirectoryInfo("Assets/BundleData/English/Texture/"), AssetBundleBuildConfig.BundleStrategy.Normal, "*.png");
                builder.AddRootTargets(new DirectoryInfo("Assets/BundleData/English/Texture/"), AssetBundleBuildConfig.BundleStrategy.Normal, "*.exr");
            }
            if (bIncludeScene)
            {
        ...
        {
            AssetBundlePathHelper.NewBundleSavePath = "AssetBundles";
            if (Directory.Exists(AssetBundlePathHelper.NewBundleSavePath))
            {
                Directory.Delete(AssetBundlePathHelper.NewBundleSavePath, true);
            }
            Directory.CreateDirectory(AssetBundlePathHelper.NewBundleSavePath);
            if (0 != ((int)buildMode & (int)BuildMode.BuidHotfix))
            {
                builder.AddRootTargets(new DirectoryInfo("Assets/BundleData/dll"), AssetBundleBuildConfig.BundleStrategy.Normal, "*.bytes");
            }
            if (0 != ((int)buildMode & (int)BuildMode.BuildTb))
            {
                builder.AddRootTargets(new DirectoryInfo("Assets/BundleData/Tables"), AssetBundleBuildConfig.BundleStrategy.Pack, "*.txt");
            }
        }
        ...
        //}
        if (buildMode == BuildMode.BuildAll)
        {
