...
namespace GameFramework
{
    ...
    {
        public static AssetBundlePathHelper pathResolver;
        ...
        public static AssetTarget LoadPack(DirectoryInfo dirInfo)
        {
            AssetTarget target = null;

            string fullPath = dirInfo.FullName;
            int nIdx = fullPath.IndexOf("Assets");
            if(nIdx != -1)
            {
                string assetPath = fullPath.Substring(nIdx)+ "\\Pack.txt";
                ...
                else
                {
                    ...
                    Debug.Log("aaaaaaaaaa  " + assetPath);
                    if(o == null)
                    {
                    ...
                    if (o != null)
                    {
                        ...
                        {
                            target = new AssetTarget(o, dirInfo, assetPath);
        ...
        {
            int nIdx = assetPath.LastIndexOf(".");
            string strPre = assetPath.Substring(0,nIdx);
            string strEnd = assetPath.Substring(nIdx+1);

            string bn = null;
            if(strEnd.Equals("FBX")|| strEnd.Equals("tga")||strEnd.Equals("controller")|| strEnd.Equals("mat")|| strEnd.Equals("jpg")|| strEnd.Equals("png"))           //图集目录下prefab和png的ab会重名
            {
                bn = assetPath;
            }
            else
            ...
            bn = HashUtil.ConvertToABName(bn);
            return bn;
        }
