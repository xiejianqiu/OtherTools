...
{ 
    ...
    {
        //[Beebyte.Obfuscator.SkipRename]
        public static AssetBundlePathHelper instance = new AssetBundlePathHelper();
        /// <summary>
        ...
        public string BundleSavePath { get {
                ...
                return "StreamingAssets/" + BundleSaveDirName; 
        } }
        public string BundleSavePathEncry = "StreamingAssets/AssetBundlesEncry";
        /// <summary>
        ...
        /// 用于缓存pkg包中解压的资源
        /// </summary>
        public string PkgBundleCacheDir = "";
        /// <summary>
        /// AB在CDN上的存放地址
        /// </summary>
